...
-- CreateIndex
CREATE UNIQUE INDEX "User_string_customer_id_key" ON "User"("string_customer_id");

-- CreateIndex
CREATE UNIQUE INDEX "User_string_subscription_id_key" ON "User"("string_subscription_id");
